...
#ifndef VSE_EMPTYCONCRETELAYER_HPP
#define VSE_EMPTYCONCRETELAYER_HPP

#include "GameLayer.hpp"

namespace vse {

// Serves no purpose other than to make creating layers easier for me, lol!
class EmptyConcreteLayer : public GameLayer {
public:
    EmptyConcreteLayer();
    ~EmptyConcreteLayer();
...
#endif // VSE_EMPTYCONCRETELAYER_HPP
